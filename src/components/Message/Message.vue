<template>
  <section class="message">
    <div class="arhip">
      <div class="ava">
        <img width="80" :src="'ava.png'" alt="">
        <p>Юрий Архипов</p>
        <h4>Директор ТОО "Copyland"</h4>
      </div>
      <p>Разработана очень удобная система приема и обработки заказов, с ней реально высвобождается огромное количество
        ресурсов.</p>
